## This edited rob_traffic_light function from robvis package for Quadas-2 tools
## So, both main domains are included in the plot


# > Edited rob_traffic_light ------------------------------------------------

# Edited from https://github.com/mcguinlu/robvis/blob/master/R/rob_traffic_light.R
...
rob_traffic_light2 <-
  function(data,
           tool,
           colour = "cochrane",
           psize = 10,## This edited rob_traffic_light function from robvis package for Quadas-2 tools
## So, both main domains are included in the plot
...
rob_traffic_light2 <-
  function(data,
    ...
    if (tool == "QUADAS-2") {
      plot <- rob_traffic_light_quadas3(
        data = data,
        tool = tool,
        rob_colours = rob_colours,
        psize = psize,
...
rob_traffic_light_quadas3 <- function(data,
                                      tool,
                                      rob_colours,
                                      psize,
                                      overall) {
...
# > helpers function in robvis ----------------------------------------------

# This is not edited, but need to run at the same time with the edited function above
# Source: https://github.com/mcguinlu/robvis/blob/master/R/helpers.R
...
# This is not edited, but need to run at the same time with the edited function above
# Source: https://github.com/mcguinlu/robvis/blob/master/R/rob_tools.R
